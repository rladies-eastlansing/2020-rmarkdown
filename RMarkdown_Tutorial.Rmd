...
## Table manipulation in RMarkdown [^2]
### Custom Typed tables
|Time         | Session | Topic    |
|:------------|:-------:|---------:|
...
Suppose we have some data that is displayed as a dataframe or matrix in the R terminal. We can include additional formating to make publication ready tables by using the `knitr::kable` and `kableExtra`. Note: **This function does not replace any of the other R packages for making tables.**  
...
### References  
[^2] https://rmd4medicine.netlify.com/materials/
